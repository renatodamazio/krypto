...
export default function Welcome() {
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-30 py-20 px-4">
        ...
        <div className="flex flex-col flex-1 items-center justify-start mf:mt-0 w-full mt-10">
